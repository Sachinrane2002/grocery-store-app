...
public class DeleteItemFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnDeleted.setBackground(new java.awt.Color(204, 0, 0));
        btnDeleted.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
    ...
    private void btnDeletedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeletedActionPerformed
       ...
       if(row==-1){
           JOptionPane.showMessageDialog(null, "NO Product Seleted!");
                return; 
       }
